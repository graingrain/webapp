 ...
 <table width="95%"  >
        ...
        <table width="900" border="0"    cellpadding="0" cellspacing="0"  >
          <tr style="border-top: 1px solid #3b8211;" bgcolor="#3b8211"> 
            <td colspan=3> <div align="center"><i><font color="#FFFFFF" size="5"><%=table%></font></i></div></td>
          </tr>
          <form action="Dispatcher" method="post" name="form"    >
            <tr bgcolor=#effceb> 
              <td width="129"  ><em><font size="-1" face="PrimaSans BT,Verdana,sans-serif">nom 
                court</font></em></td>
              <td width="470" colspan="2"  bgcolor=#effceb> &nbsp; <input type="text"   name="nom" size="50" value="<%=E.getPa_nom()%>"> 
            ...
            <tr bgcolor=#effceb> 
              <td   ><em><font size="-1" face="PrimaSans BT,Verdana,sans-serif">nom 
                long</font></em></td>
              <td colspan="2">&nbsp; <input type="text" name="nomc" size="60" value="<%=E.getPa_nomc()%>"> 
              </td>
            </tr>
            <tr bgcolor=#effceb> 
              <td   ><em><font size="-1" face="PrimaSans BT,Verdana,sans-serif">description</font></em></td>
              <td colspan="2">&nbsp; <textarea name="description" cols="50" rows="4"><%=E.getPa_description()%></textarea> 
              </td>
            </tr>
            <tr bgcolor=#effceb> 
              <td  > <em><font size="-1" face="PrimaSans BT,Verdana,sans-serif">Division</font></em> 
              </td>
              <td colspan="2"> &nbsp; <% if((userinfo.getProfil()>2)&&(E.getPa_integrite()==0)) { %> <select name="pldv_code" size="1">
            ...
            <tr bgcolor=#CCCC66> 
              ...
              <td> 
                <p>&nbsp; </p></td>
              <td> 
                <select name="usager_code" size="1" onchange="Valider(this.form,'AjouterUsager')">
            ...
            <tr bgcolor=#CCCC66> 
              ...
              <td>&nbsp; &nbsp;&nbsp; lecture 
                ...
                ecriture 
                <input type="radio" name="droit" value="rwx"   > </td>
              <td> 
                <select name="groupe_code" size="1"  onchange="Valider(this.form,'AjouterGroupe')">
                  <option value=0;0>faire un choix</option>
                  ...
                  <option value=<%=item.getDv_code()%>;<%=item.getSv_code()%>;<%=item.getBu_code()%>><%=item.getDv_nom()%>- <%=item.getSv_nom()%>- 
            ...
            <tr bgcolor=#CCCC66> 
              ...
              <td> 
                <p>&nbsp; 
              <td> 
                <select name="membre_code" size="1" onchange="Valider(this.form,'AjouterMembre')">
                  <option value=0;0>faire un choix</option>
