...
<table style="width:100%; margin-top: 1em;" border="0">
	<tr  class="titre1">    <td style="border-top: 1px solid #3b8211;" height="1" colspan=13><p class="nom">Liste des partages Scribe</p></td>  </tr>     
...
{  
        ...
        <tr> 
          ...
          <td width="231"   ><img src="4.GIF" width="5" height="5">&nbsp; <span class="titre1"> <a href="Dispatcher?operation=partage&codepa=<%=D.getPa_code()%>&codedv=<%=D.getPa_dv_code()%>&table=partage" class="lien_noir14_none" title="<%=D.getPa_nomc()%>" ><%=D.getPa_nom()%></a></span>
              <span class="Style1">(<%=D.getPa_integrite()%>)	</span>		   
               &nbsp;&nbsp;<%=D.getPa_nomc()%> </td>
          <td width="167"     valign="top" > 
		 </td>
          <td width="373" valign="top"  class="lienoutils"><em> </em></td>
        </tr>
<% } %>
      </table>
<% } %>   
<% } %>    
<br> 
<!--liste des personnels----->  <%@ include file="include_liste_agent-karine.htm"%>
