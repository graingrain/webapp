  ...
  <div id="content">
    <div id="content-row1">
      ...
      <div id="cabinet" class="row1-contour-couleur">
       <h1><a href="Dispatcher?operation=division&amp;codedv=66">cabinet</a></h1>
        <h2>Directeur&nbsp;:<span class="nom"> Marie-Claude&nbsp;Boyer-Roche</span></h2>
        <h2>Charg&eacute;e&nbsp;de&nbsp;communication&nbsp;:<span class="nom"> Isabelle&nbsp;de&nbsp;Lavergne</span></h2>
      </div>
      <div id="mediatrice" class="row1-contour-gris">
      <h2><a href="Dispatcher?operation=division&amp;codedv=724">M&eacute;diatrice&nbsp;: Christiane&nbsp;Andr&eacute;</a></h2>
      </div>
    </div>
    <div id="content-row2"><div id="daasen" class="row2-fond-couleur">
       <h1><a href="Dispatcher?operation=division&amp;codedv=73">Inspecteur d'acad&Eacute;mie, directeur acad&Eacute;mique adjoint<br>
        des services de l'&Eacute;ducation nationale</a> </h1>
        <h2><span class="nom">Jean-Fran&ccedil;ois Salles</span></h2>
        <p>&nbsp;</p>
      ...
      <div id="sg" class="row2-fond-couleur">
       <h1><a href="Dispatcher?operation=division&amp;codedv=65">Secr&Eacute;taire g&Eacute;n&Eacute;ral</a> </h1>
        ...
        <p class="nom">Yann&nbsp;Cou&euml;dic</p>
        <p class="nom">Erwan Polard</p>
    ...
    <div id="content-row4"><div id="pedagogique" class="row4-fond-rouge">
       <h2 class="pole">P&eacute;dagogie
        ...
        <p><a href="Dispatcher?operation=agent&table=agent&codepl=53&codedv=71&codesv=0&codebu=0&codeag=960">Doyen des IEN enseignement technique et g&eacute;n&eacute;ral&nbsp;: <span class="nom">Régis Bucquet</span></a></p>
        <p><a href="Dispatcher?operation=agent&table=agent&codepl=53&codedv=70&codesv=0&codebu=0&codeag=1526">Doyen des IA-IPR&nbsp;: Pascal Schrapffer</a></p>
        <p><a href="Dispatcher?operation=agent&table=agent&codepl=53&codedv=70&codesv=0&codebu=0&codeag=771">IA-IPR Vie scolaire&nbsp;: <span class="nom">Brigitte&nbsp;Bertil / Ir&egrave;ne Ilef-Penhouet</span></a><span class="nom"></span></p>
...
<p><a href="Dispatcher?operation=division&amp;codedv=75">Recherche-d&eacute;veloppement, Innovation et exp&eacute;rimentation (CARDIE)&nbsp;: <span class="nom">Pascal&nbsp;Chabernaud</span></a> <a href="Dispatcher?operation=division&amp;codedv=75" class="conseiller-technique">(CT*)</a></p>
        </div>
      </div>
            <div id="scolarite" class="row4-fond-corail">
        <h2 class="pole">Scolarit&eacute;-partenariats</h2>
        <p><span class="sg">Erwan Polard</span></p>
...
<p><a href="Dispatcher?operation=division&codedv=41">Structures et moyens (DSM)&nbsp;: <span class="nom">Marie-Sabine&nbsp;Lauret</span></a></p>
        </div>
      </div>
      <div id="budget" class="row4-fond-prune">
        ...
        <p><a href="Dispatcher?operation=division&codedv=22">Services informatiques (DSI)&nbsp;: <span class="nom">Philippe Derouette</span></a></p>
      ...
      <div id="ressources-humaines" class="row4-fond-marine">
        ...
        <p><a href="Dispatcher?operation=division&codedv=36">Personnels de l'enseignement primaire (DPEP)&nbsp;: <span class="nom">Maryvonne&nbsp;Cl&eacute;ment</span></a><span class="nom"></span> </p>
          <p><a href="Dispatcher?operation=division&codedv=35">Personnels de l'enseignement 
            ...
            Semp&egrave;re </span></a><span class="nom"></span></p>
      ...
      <div id="sante-social" class="row4-fond-gris">
        ...
        <p>&nbsp;</p>
        <div class="pole-content">
        <p><a href="Dispatcher?operation=division&codedv=74">M&eacute;decine de pr&eacute;vention (MDP)&nbsp;: <span class="nom">Fr&eacute;d&eacute;ric Le Bot</span></a> <a href="Dispatcher?operation=division&amp;codedv=75" class="conseiller-technique">(CT*)</a></p>
        <p><a href="Dispatcher?operation=division&codedv=82">Service infirmier&nbsp;: <span class="nom">Ana-Maria&nbsp;Ebro</span></a> <a href="Dispatcher?operation=division&amp;codedv=75" class="conseiller-technique">(CT*)</a></p>
        <p><a href="Dispatcher?operation=division&codedv=49">Service m&eacute;dical en faveur des &eacute;l&egrave;ves (SPSFE)&nbsp;: <span class="nom">Thierry Baranes</span></a> <a href="Dispatcher?operation=division&amp;codedv=75" class="conseiller-technique">(CT*)</a></p>
        <p><a href="Dispatcher?operation=division&codedv=79">Service social des personnels (SSP)&nbsp;: <span class="nom">Amina&nbsp;Banian</span></a></p>
        <p><a href="Dispatcher?operation=division&codedv=64">Service social en faveur des &eacute;l&egrave;ves (SSFE)&nbsp;: <span class="nom">Fran&ccedil;oise&nbsp;Penent</span></a> <a href="Dispatcher?operation=division&amp;codedv=75" class="conseiller-technique">(CT*)</a></p>
      <p><a href="Dispatcher?operation=division&codedv=53">Hygi&egrave;ne et s&eacute;curit&eacute; (DAHS)&nbsp;: <span class="nom">Christian&nbsp;Ecolivet</span></a> <a href="Dispatcher?operation=division&amp;codedv=75" class="conseiller-technique">(CT*)</a></p>
        </div>
      </div>
      <p><span class="conseiller-technique">CT* = Conseiller technique du recteur</span></p>
    </div>
      <div id="content-row5"><div id="instances" class="row1-contour-gris">
        <h2><span class="nom">Instances de consultation</span></h2>
        <p>Comit&eacute; acad&eacute;mique de pilotage de l'&eacute;ducation prioritaire</p>
