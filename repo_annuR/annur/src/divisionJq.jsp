...
$(document).ready(function(){
 $("#flip").click(function(){ $("#division").slideToggle("slow");  });
 $("#flippartage").click(function(){ $("#partage").slideToggle("slow");  });
 $("#fade").click(function () {
        this.toggle = !this.toggle;
        $("#division").stop().fadeTo(400, this.toggle ? 0.4 : 1);
    });
});
</script>
...
<tr  class="titre1">    
<td style="border-top: 1px solid #3b8211;" height="1" colspan=13><p class="nom">Liste des partages Scribe</p></td> 
</tr></table>
</div>    
<div  id=partage >  
<table style="width:100%; margin-top: 1em;" border="0" cellspacing="0">
