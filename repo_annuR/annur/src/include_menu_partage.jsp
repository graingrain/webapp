...
function control0() {
if (document.form0.recherche.value == "." ) {     return true ;  }
if (document.form0.recherche.value.length < 3) {
   alert("3 lettres minimum ...")
   document.form0.recherche.focus()
   return false
}
function control1() {
...
<div id="formulaire">
<form class="menu"  name="form0" method="post" action="Dispatcher?operation=recldap" onsubmit='return control0()'>
                <input name="nom"         type="text"     size="10"> 
                ET 
				<input name="fonct"       type="text"     size="10">     
                <input name="table"       type="hidden"   value="partagelisteldap">
				<input name="type"        type="hidden"   value=" "> 
                <input name="code"        type="hidden"   value="-1"> 
                <input type="submit" name="recherchealdap"  value="Recherche Ldap"  >
<span class="vert">recherche sur le nom    ET  fredufonctadm -  Ajouter agent dans le partage  </span>
</form>
...
<a style="float:right; color:red; font-size:0.8em; padding-top:2px" href="http://www.ac-reunion.fr/fileadmin/rep_services/rep_communication/rep_academie/organigramme/organigramme-rectorat-de-la-reunion.pdf"> T&eacute;l&eacute;charger l'organigramme de l'acad&eacute;mie de la R&eacute;union en PDF </a>
