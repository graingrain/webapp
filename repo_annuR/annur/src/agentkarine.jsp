...
System.out.println("debut :" + table +".jsp --- profil:" + userinfo.getUser() + " --- " + userinfo.getProfil());
System.out.println("---------------------------------------------------------------------" );
%>
...
<table width="93%" border="0" bgcolor="#FFFFFF"   >
...
if (E.getAg_code()>0) {
%>
     <td colspan="2"  ><p> <a href="Dispatcher?operation=division&amp;codedv=<%=E.getDv_code()%>"><%=E.getDv_nom()%></a>,&nbsp;<%=E.getDv_nomc()%>
        <% if(E.getSv_code()>0) { %>
      <p><span class="titre1"><a href="Dispatcher?operation=service&amp;codedv=<%=E.getDv_code()%>&amp;codesv=<%=E.getSv_code()%>"><%=E.getSv_nom()%></a>,&nbsp;<%=E.getSv_nomc()%></span> <br>
        <% } %>
        <br>
		<div style="width:800px; border-top: 1px solid #3b8211; height:3px;">&nbsp;</div>
      <!--  <img src="images-foad/orange2.gif" width="800" height="2" alt="">--><br>
        <br>
          ...
          <td width="469"><p> <img src="images-foad/transp.gif" width="10" height="5" alt=""> <img src="4.GIF" width="10" height="5" alt=""><strong>&nbsp;<%=E.getAg_ldap_nom()%></strong> <strong><%=E.getAg_ldap_prenom()%></strong>&nbsp; <strong> </strong>
            ...
            <table width="75%"  >
              ...
              <tr>
                ...
                <td width="74%"><font color="#0000FF"><%=E.getAf_telephone()%></font> </td>
              </tr>
              <tr>
      ...
      <table width=800 align="left" bgcolor="#FFFFFF"  >
        <tr bgcolor="#DEF0D9">
          <td><table width=700 border="0" align="left"  cellpadding="0" cellspacing="0" bgcolor="#DEF0D9">
              <tr   id=titre_tr>
              ...
              <form action="Dispatcher" method="post" name="form"   onsubmit='return control()'>
                ...
                <tr bgcolor=white>
                  ...
                  <td><input type="text" name="numen" size="60" value="<%=E.getAg_ldap_numen()%>"></td>
                </tr>
                <tr bgcolor=white>
                ...
                <tr bgcolor=white>
                  <td colspan=2 ><%System.out.println("nb ldap:"+allldap.size());%>
                    <% if(allldap.size()>=0) { %>
                    <font size=3>Liste ldap: </font> <br>
                    <table width="75%" border="1" align="left">
                      <tr bgcolor="#DEF0D9">
                        <td>
<div align="center"><strong>nom</strong></div></td>
    ...
    <img src="images-foad/transp.gif" width="10" height="5" alt=""> </tr>
  <tr>
    <td width="90%"></td>
  </tr>
</table>
