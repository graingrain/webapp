...
public class ItemSun implements Comparable {
    // agent
    ...
    public int compareTo(Object anotherAnnuaire) throws ClassCastException {
        if (!(anotherAnnuaire instanceof ItemAnnuaire))
            throw new ClassCastException("A ItemSun object expected.");
...
class UidComparator implements Comparator {
  public int compare(Object ItemSun, Object anotherItemSun) {
    String lastName1 = ((ItemSun) ItemSun).getAg_ldap_uid().toUpperCase();
    String firstName1 = ((ItemSun) ItemSun).getAg_ldap_nom().toUpperCase();
    String lastName2 = ((ItemSun) anotherItemSun).getAg_ldap_uid().toUpperCase();
    String firstName2 = ((ItemSun) anotherItemSun).getAg_ldap_nom().toUpperCase();
...
class FirstNameComparator implements Comparator {
  public int compare(Object ItemSun, Object anotherItemSun) {
    String lastName1 = ((ItemSun) ItemSun).getAg_ldap_nom().toUpperCase();
    String firstName1 = ((ItemSun) ItemSun).getAg_ldap_prenom().toUpperCase();
    String lastName2 = ((ItemSun) anotherItemSun).getAg_ldap_nom().toUpperCase();
    String firstName2 = ((ItemSun) anotherItemSun).getAg_ldap_prenom().toUpperCase();
