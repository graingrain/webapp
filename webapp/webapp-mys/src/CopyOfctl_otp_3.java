...
public class CopyOfctl_otp_3 {
    
    public CopyOfctl_otp_3() {     }
    ...
    throws IOException, SQLException {
        ...
        try {
            ...
            while((ligne = entree.readLine()) != null) {
                ...
                if(ligne.length() > 15 && ligne.substring(0, 7).equals("include") ||(ligne.indexOf("ct-httpd") != -1) ) {
                    ...
                    while((ligne2 = entree_include.readLine()) != null) {
                        ...
                        if(ligne2.length() > 13 && ligne2.substring(0, 12).equals("WebAppDeploy")) {
                            ...
                            if(host.length() > 0 && port > 0 && location.length() > 0) {
                                etat = socket2( stmt_maj, "webappD", host, port, "tomcat warp:" + location);
                                location = "";
                            }
                        }
                        ...
                        if(ligne2.length() > 6 && ligne2.indexOf("Mount") != -1) {
                            ...
                            etat = socket2( stmt_maj, "tomcat" , thost[trouve], tport[trouve], "tomcat(modjk)   :" + tloca[trouve]);
                        }
                    }
                }
            }
    ...
    public static String socket2( Statement stmt_maj, String type_host, String host, int port, String type)
    throws IOException {
        String reponse = "1";
        if(port == 0)
            return reponse;
