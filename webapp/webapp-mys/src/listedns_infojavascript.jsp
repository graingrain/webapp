...
<table border="0" cellspacing="0" width=700 cellpadding="0" align="center">
  ...
  <tr bgcolor=white >      
           <td width="61">  <div align="center"><a href="Dispatcher?operation=cp&tri=cp_nat"> 
              </a><b><i><font color="#9999CC">Name</font></i></b></div>    </td>
         
          <td width="61">  <div align="center"><a href="Dispatcher?operation=cp&tri=cp_nat"> 
              </a><b><i><font color="#9999CC">Mayotte</font></i></b></div>    </td>
          <td width="93">  <div align="center"><a href="Dispatcher?operation=cp&tri=cp_ip"> 
              </a> <b><i><font color="#9999CC">Comores</font></i></b></div> </td>
          <td width="93">  <div align="center"><a href="Dispatcher?operation=cp&tri=cp_ip"> 
              </a> <b><i><font color="#9999CC">Etab</font></i></b></div> </td>
   ...
   ArrayList liste       = (ArrayList)session.getValue("liste_dns") ;
		...
		<tr  bgcolor=white  onmouseover="setPointer(this, '#FFFFCC')" onmouseout="setPointer(this, '#ffffff')" > 
          <td width="353"><a href="Dispatcher?operation=onedns&node=<%=oldnode%>"><font color="#000033" size="3"> 
            <%=old%></font> </a></td>
          ...
          <td width="104"> <div align="center">
            ...
            <%=T[2]%></font></div>
			<img src="arrow.gif" onMouseOver="FoToolTip.show(this,'<%=TIP[2]%>')"> 
